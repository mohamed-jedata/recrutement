    ...
    */
    ...
    'custom' => [
        'nom' => [
            ...
            'alpha' => 'Nom ne doit contenir que des lettres',
        ],
        'prenom' => [
            'required' => 'Prenom est obligatoire',
            'alpha' => 'Prenom ne doit contenir que des lettres',
        ],
        'e_mail' => [
        ...
        'orgnom' => [
            'required' => 'Nom d\'entreprise est obligatoire',
        ],
        'orgcode_postal' => [
            'required' => 'Code postal est obligatoire',
            'numeric ' => 'Code postal doit etre numérique',
        ],
        'orgville'=> [
